...
| D6 | Resample / scope descriptors / grid | Subtronics workflow | ✅ Phase 75 |

Modulation infra complete in Patch Lab; remaining P3 gaps are M/S mono bass and spectral ducking (future).
